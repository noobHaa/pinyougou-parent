							...
							<div class="items">
                                <ul>
									<#list imageList as image>
                                        <li><img src="${image.url}" bimg="${image.url}" onmousemove="preview(this)" width="400px" height="400px"/></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
							...
							<#list specificationList as specification>
                                <dl>
                                    ...
                                    <#list specification.attributeValue as item>
                                        <dd><a
                                               class="{{isSelect('${specification.attributeName}','${item}') ? 'selected':''}}"
                           ...
                           {{selectSpecification}}
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="cart.html" class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
